...
export const careers = [
  ...
  },
  {
    ...
    "whatTheyDo": "Security engineers design, implement, and operate security solutions. Unlike analysts who monitor threats, engineers build the tools and systems that prevent and detect them â€” from IAM systems to SIEM pipelines.",
    "responsibilities": [
  ...
  },
  {
    ...
    "iconType": "code",
    "icon": "",
    "blurb": "Create clear, accurate technical documentation â€” from API references to user guides â€” that empowers developers and users.",
    "summary": "Create clear, accurate technical documentation â€” from API references to user guides â€” that empowers developers and users.",
    "demand": "Stable",
    "workMode": "Remote / Hybrid",
    "roadmapId": "software-developer",
    "salary": {
